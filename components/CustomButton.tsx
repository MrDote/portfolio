...
const CustomButton = () => {
    ...
    return (
        ...
        className={`md:hidden relative flex justify-center items-center cursor-pointer transition duration-500 ease-in-out w-20 h-20 box-border dark:bg-slate-50`}>
            <div 
            ...
            ${isVis ? `translate-x-[-3rem] bg-transparent shadow-none pointer-events-none
