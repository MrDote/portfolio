...
const CustomButton = ({isOut, setIsOut}: propsType) => {
    ...
    return (
        ...
        className={`md:hidden absolute flex justify-center items-center cursor-pointer transition-all duration-500 ease-in-out w-20 h-20 box-border z-20 right-6 top-3`}>
            <div 
