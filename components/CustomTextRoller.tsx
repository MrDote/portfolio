    ...
    <div className="flex -z-10">
        ...
        <div className='relative select-none'>
            <div className="flex flex-col text-center h-60 justify-end py-1
                before:bg-bg-light dark:before:bg-bg-dark before:w-full before:h-[8.5em] before:absolute before:top-0 before:z-10
                after:bg-bg-light dark:after:bg-bg-dark after:w-full after:h-[4.3em] after:absolute after:bottom-0
                sm:before:h-[7.5em]
                sm:after:h-[5.0em]
            ">
