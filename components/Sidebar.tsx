...
const Sidebar = ({isOut, setIsOut}: {isOut: boolean, setIsOut: () => void}) => {
  ...
  // custom hook to track window width
    ...
    return (
        <div 
        className={`transition-all duration-500 ease-in-out fixed right-0 top-0 w-full h-screen md:hidden
        ${isOut ? `bg-black/60` : ``}
        `}>
            ...
            ${isOut ? `bg-slate-50` : `translate-x-40 opacity-0 invisible`}
            `}>
                <div>
                    ...
                    <div className='uppercase tracking-widest text-sky-500 pt-44'>
                        <div>
