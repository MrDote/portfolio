    ...
    return (
        ...
        `}>
            ...
            `}>
                ...
                <div className='uppercase font-semibold text-lg py-5 overflow-auto'>
                ...
                <div className='uppercase tracking-widest text-sky-600 absolute bottom-2 right-0 left-0 mx-10'>
                    <div>
                        <p>Let's Connect!</p>
                    </div>
